...
public class JarBinarySpecSpecializationModelInitializer<T> extends ManagedModelInitializer<T> {
    ...
    public JarBinarySpecSpecializationModelInitializer(ModelManagedImplStructSchema<T> modelSchema, NodeInitializerRegistry nodeInitializerRegistry) {
        super(modelSchema, nodeInitializerRegistry);
    }
