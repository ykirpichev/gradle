...
public class JarBinarySpecSpecializationModelInitializer<T> extends ManagedModelInitializer<T> {
    ...
    public JarBinarySpecSpecializationModelInitializer(ModelManagedImplStructSchema<T> modelSchema, ModelSchemaStore store, NodeInitializerRegistry nodeInitializerRegistry) {
        super(modelSchema, store, nodeInitializerRegistry);
    }
