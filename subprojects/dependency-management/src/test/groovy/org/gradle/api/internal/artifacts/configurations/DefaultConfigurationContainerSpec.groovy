...
public class DefaultConfigurationContainerSpec extends Specification {
    ...
    private ResolverResultsToResolvedConfigurationAdapter resolverResultsAdapter = Mock()
    ...
    private DefaultConfigurationContainer configurationContainer = new DefaultConfigurationContainer(
        ...
        listenerManager, metaDataProvider, projectAccessListener, projectFinder, resolverResultsAdapter);
    ...
    def "adds and gets"() {
        ...
        1 * instantiator.newInstance(DefaultConfiguration.class, ":compile", "compile", configurationContainer,
                resolver, listenerManager, metaDataProvider, _ as ResolutionStrategyInternal, projectAccessListener, projectFinder, resolverResultsAdapter) >> conf
