...
afterEach DefaultCustomComponent 'newComponent'"""))
    ...
    def "reasonable error message when creating component with default implementation"() {
        ...
        and:
        failure.assertThatCause(containsText("The model node of type: 'DefaultCustomComponent' can not be constructed. The type must be managed (@Managed) or one of the following types [FunctionalSourceSet, ModelSet<?>, ManagedSet<?>, ModelMap<?>, List, Set]"))
    }
    ...
    def "reasonable error message when creating component with no implementation"() {
        ...
        and:
        failure.assertThatCause(containsText("The model node of type: 'AnotherCustomComponent' can not be constructed. The type must be managed (@Managed) or one of the following types [FunctionalSourceSet, ModelSet<?>, ManagedSet<?>, ModelMap<?>, List, Set]"))
    }
